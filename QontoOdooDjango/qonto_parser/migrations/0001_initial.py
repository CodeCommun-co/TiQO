# Generated by Django 4.1.7 on 2023-03-05 07:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qonto_parser.category')),
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qonto_parser.label')),
            ],
        ),
    ]
